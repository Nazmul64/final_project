...
<!-- Mirrored from htmldemo.net/jesco/jesco/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Mar 2024 17:15:38 GMT -->
<head>
    <meta charset="UTF-8">
    ...
    <!-- Add site Favicon -->
    <link rel="shortcut icon" href="{{ asset('forntend/assets/images/favicon/favicon.ico')}}" type="image/png">

    <!-- vendor css (Icon Font) -->
    <link rel="stylesheet" href="{{ asset('forntend/assets/css/vendor/bootstrap.bundle.min.css')}}" />
    <link rel="stylesheet" href="{{ asset('forntend/assets/css/vendor/pe-icon-7-stroke.css')}}" />
    <link rel="stylesheet" href="{{ asset('forntend/assets/css/vendor/font.awesome.css')}}" />
    ...
    <link rel="stylesheet" href="{{ asset('forntend/assets/css/plugins/nice-select.css')}}" />
    <link rel="stylesheet" href="{{ asset('forntend/assets/css/plugins/venobox.css')}}" />
...
<body>
                ...
                <div class="row">
                    <div class="col-auto align-self-center">
                        <div class="header-logo">
                            <a href="index.html"><img src="{{asset('forntend')}}/assets/images/logo/logo.png" alt="Site Logo" /></a>
                        </div>
                    </div>
        ...
        <div class="inner">
            ...
            <div class="body customScroll">
                <ul class="minicart-product-list">
                    <li>
                        <a href="single-product.html" class="image"><img src="{{asset('forntend')}}/assets/images/product-image/1.jpg"
                    ...
                    <li>
                        <a href="single-product.html" class="image"><img src="{{asset('forntend')}}/assets/images/product-image/2.jpg"
                                alt="Cart product Image"></a>
                        <div class="content">
                    ...
                    <li>
                        <a href="single-product.html" class="image"><img src="{{asset('forntend')}}/assets/images/product-image/3.jpg"
                                alt="Cart product Image"></a>
                        <div class="content">
                            ...
                            <div
                                ...
                                <div class="show-case">
                                    <div class="hero-slide-image">
                                        <img src="{{asset('forntend')}}/assets/images/slider-image/slider-2-1.png" alt="" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="container align-self-center">
                        <div class="row">
                            ...
                            <div
                                ...
                                <div class="show-case">
                                    <div class="hero-slide-image">
                                        <img src="{{asset('forntend')}}/assets/images/slider-image/slider-2-2.png" alt="" />
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    ...
                    <div class="single-feature">
                        <div class="feature-icon">
                            <img src="{{asset('forntend')}}/assets/images/icons/1.png" alt="">
                        </div>
                ...
                <div class="col-lg-4 col-md-6 mb-md-30px mb-lm-30px mt-lm-30px">
                    <div class="single-feature">
                        <div class="feature-icon">
                            <img src="{{asset('forntend')}}/assets/images/icons/2.png" alt="">
                        </div>
                        <div class="feature-content">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-feature">
                        <div class="feature-icon">
                            <img src="{{asset('forntend')}}/assets/images/icons/3.png" alt="">
                        </div>
                        <div class="feature-content">
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img src="{{asset('forntend')}}/assets/images/product-image/1.jpg" alt="Product" />
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-30px" data-aos="fade-up"
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img src="{{asset('forntend')}}/assets/images/product-image/3.jpg" alt="Product" />
                                ...
                                <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-30px" data-aos="fade-up"
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img src="{{asset('forntend')}}/assets/images/product-image/5.jpg" alt="Product" />
                                ...
                                <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-30px" data-aos="fade-up"
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img src="{{asset('forntend')}}/assets/images/product-image/7.jpg" alt="Product" />
                                ...
                                <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-md-30px mb-lm-30px"
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img src="{{asset('forntend')}}/assets/images/product-image/2.jpg" alt="Product" />
                                ...
                                <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6  mb-md-30px mb-lm-30px"
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img src="{{asset('forntend')}}/assets/images/product-image/4.jpg" alt="Product" />
                                ...
                                <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 mb-es-30px" data-aos="fade-up"
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img src="{{asset('forntend')}}/assets/images/product-image/6.jpg" alt="Product" />
                                ...
                                <div class="col-lg-4 col-xl-3 col-md-6 col-sm-6 col-xs-6 " data-aos="fade-up"
                                    ...
                                    <div class="product">
                                        <div class="thumb">
                                            <a href="single-product.html" class="image">
                                                <img src="{{asset('forntend')}}/assets/images/product-image/8.jpg" alt="Product" />
                                ...
                                <div class="new-product-wrapper swiper-wrapper">
                                    ...
                                    <div class="new-product-item swiper-slide">
                                        ...
                                        <div class="product">
                                            <div class="thumb">
                                                <a href="single-product.html" class="image">
                                                    <img src="{{asset('forntend')}}/assets/images/product-image/9.jpg" alt="Product" />
                                    ...
                                    <div class="new-product-item swiper-slide">
                                        ...
                                        <div class="product">
                                            <div class="thumb">
                                                <a href="single-product.html" class="image">
                                                    <img src="{{asset('forntend')}}/assets/images/product-image/10.jpg" alt="Product" />
                                                    <img class="hover-image" src="assets/images/product-image/2.jpg"
                                                        alt="Product" />
                                                </a>
                                                <span class="badges">
                                    ...
                                    <div class="new-product-item swiper-slide">
                                        ...
                                        <div class="product">
                                            <div class="thumb">
                                                <a href="single-product.html" class="image">
                                                    <img src="{{asset('forntend')}}/assets/images/product-image/11.jpg" alt="Product" />
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 mb-md-30px mb-lm-30px">
                    <div class="single-blog">
                        <div class="blog-image">
                            <a href="blog-single-left-sidebar.html"><img src="{{asset('forntend')}}/assets/images/blog-image/1.jpg"
                ...
                <div class="col-lg-4 mb-md-30px mb-lm-30px">
                    <div class="single-blog ">
                        <div class="blog-image">
                            <a href="blog-single-left-sidebar.html"><img src="{{asset('forntend')}}/assets/images/blog-image/2.jpg"
                                    class="img-responsive w-100" alt=""></a>
                        </div>
                        <div class="blog-text">
                            <div class="blog-athor-date">
                ...
                <div class="col-lg-4">
                    <div class="single-blog">
                        <div class="blog-image">
                            <a href="blog-single-left-sidebar.html"><img src="{{asset('forntend')}}/assets/images/blog-image/3.jpg"
                                    class="img-responsive w-100" alt=""></a>
                        </div>
                        <div class="blog-text">
                            <div class="blog-athor-date">
                        ...
                        <div class="col-md-6 col-lg-3 mb-md-30px mb-lm-30px">
                            <div class="single-wedge">
                                <div class="footer-logo">
                                    <a href="index.html"><img src="{{asset('forntend')}}/assets/images/logo/logo-white.png" alt=""></a>
                                </div>
                        ...
                        <div class="col-md-4 col-lg-3 col-sm-6">
                            <div class="single-wedge">
                                ...
                                <div class="footer-links">
                                    ...
                                    <img src="{{asset('forntend')}}/assets/images/icons/payment.png" alt="" class="payment-img img-fulid">
    ...
    <script src="{{ asset('forntend/assets/js/vendor/jquery-3.6.0.min.js') }}"></script>
    <script src="{{ asset('forntend/assets/js/vendor/jquery-migrate-3.3.2.min.js') }}"></script>
    <script src="{{ asset('forntend/assets/js/vendor/bootstrap.bundle.min.js') }}"></script>
    <script src="{{ asset('forntend/assets/js/plugins/swiper-bundle.min.js') }}"></script>
    <script src="{{ asset('forntend/assets/js/plugins/jquery-ui.min.js') }}"></script>
    <script src="{{ asset('forntend/assets/js/plugins/jquery.nice-select.min.js') }}"></script>
    <script src="{{ asset('forntend/assets/js/plugins/countdown.js') }}"></script>
    ...
    <script src="{{ asset('forntend/assets/js/plugins/venobox.min.js') }}"></script>
    <script src="{{ asset('forntend/assets/js/plugins/ajax-mail.js') }}"></script>
    <script src="{{ asset('forntend/assets/js/main.js') }}"></script>
</body>


<!-- Mirrored from htmldemo.net/jesco/jesco/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 26 Mar 2024 17:15:46 GMT -->
</html>
