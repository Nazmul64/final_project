...
{{-- <head> --}}
        ...
        <!-- App css -->
        <link href="{{asset(asset('dashboard/assets/css/bootstrap.min.css'))}}" rel="stylesheet" type="text/css" id="bootstrap-stylesheet" />
        <link href="{{asset(asset('dashboard/assets/css/icons.min.css'))}}" rel="stylesheet" type="text/css" />
        <link href="{{asset(asset('dashboard/assets/css/app.min.css'))}}" rel="stylesheet" type="text/css"  id="app-stylesheet" />
            ...
            <div class="navbar-custom">
                ...
                <div class="logo-box">
                    <a href="index.html" class="logo text-center">
                        <span class="logo-lg">
                            <img  height="100px" width="100" src="{{asset('uploads/profile_photos/'.Auth::user()->profile_photo)}}" alt="" height="25">
                    ...
                    <div id="sidebar-menu">
                        ...
                        <ul class="metismenu" id="side-menu">
                            ...
                            <li>
                                ...
                                <ul class="nav-second-level" aria-expanded="false">
                                    <li><a href="{{route('vandor.create')}}">Add Vandor</a></li>
                                    <li><a href="">List Vandor</a></li>
                                </ul>
                            </li>
                            @endif
                             @if (Auth::user()->role==3)
